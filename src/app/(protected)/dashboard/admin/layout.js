    ...
    <div className={styles.dashboardContainer}>
      ...
      <aside className={`${styles.sidebar} ${menuOpen ? styles.open : ""}`}>
        ...
        <ul>
          ...
          <li><a href="/dashboard/admin/usuarios">Usuários</a></li>
          <li><a href="/dashboard/admin/carga">- Cargas cadastradas</a></li>
          <li><a href="/dashboard/admin/cliente">- Clientes cadastrados</a></li>
          <li><a href="/dashboard/admin/motorista">- Motoristas</a></li>
          <li><a href="/dashboard/admin/veiculo">- Veículos</a></li>
